(function (p, j) {
    ...
    function S(a) {
        var b, e = [], g = [], f = arguments, l, k, s, m, r, y;
        ...
        if (!(a.liveFired === this || !k || !k.live || a.button && a.type === "click")) {
            ...
            r = 0;
            for (y =
                     l.length; r < y; r++) for (m = 0; m < B.length; m++) {
                k = B[m];
    ...
    function ea(a, b) {
        ...
        b.each(function () {
            if (this.nodeName === (a[e] && a[e].nodeName)) {
                var g = c.data(a[e++]), f = c.data(this, g);
                if (g = g && g.events) {
                    delete f.handle;
                    f.events = {};
    ...
    var c = function (a, b) {
        ...
        }, oa = p.jQuery, J = p.$, v = p.document, N, K = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, M = /^.[^:#\[\.,]*$/,
        ka = /\S/, $ =
            /^(\s|\u00A0)+|(\s|\u00A0)+$/g, Ya = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, ga = navigator.userAgent, Fa = false,
        ha = [], aa, pa = Object.prototype.toString, qa = Object.prototype.hasOwnProperty, ra = Array.prototype.push,
        ia = Array.prototype.slice, Ga = Array.prototype.indexOf;
    c.fn = c.prototype = {
        init: function (a, b) {
            var e, g;
            if (!a) return this;
            ...
            if (typeof a === "string") if ((e = K.exec(a)) &&
                ...
                return c.merge(this,
                    a)
            } else return !b || b.jquery ? (b || N).find(a) : c(b).find(a); else if (c.isFunction(a)) return N.ready(a);
            if (a.selector !== j) {
            ...
            if (b ===
                "find") g.selector = this.selector + (this.selector ? " " : "") + e; else if (b) g.selector = this.selector + "." + b + "(" + e + ")";
            return g
        }, each: function (a, b) {
            return c.each(this, a, b)
        }, ready: function (a) {
            c.bindReady();
            if (c.isReady) a.call(v, c); else ha && ha.push(a);
            return this
        }, eq: function (a) {
        ...
        }, push: ra, sort: [].sort, splice: [].splice
    };
    c.fn.init.prototype = c.fn;
    c.extend = c.fn.extend = function () {
        var a = arguments[0] || {}, b = 1, e = arguments.length, g = false, f, l, k, s;
        if (typeof a === "boolean") {
            g = a;
            a = arguments[1] || {};
            b = 2
    ...
    c.extend({
        noConflict: function (a) {
            ...
            if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return p.JSON && p.JSON.parse ? p.JSON.parse(a) :
                (new Function("return " + a))(); else c.error("Invalid JSON: " + a)
        }, noop: function () {
        }, globalEval: function (a) {
            if (a && ka.test(a)) {
                var b = v.getElementsByTagName("head")[0] || v.documentElement, e = v.createElement("script");
                e.type = "text/javascript";
                if (c.support.scriptEval) e.appendChild(v.createTextNode(a)); else e.text = a;
            ...
            var g, f = 0, l = a.length, k = l === j || c.isFunction(a);
            ...
            for (var e =
                0, g = b.length; e < g; e++) if (b[e] === a) return e;
            return -1
        }, merge: function (a, b) {
            var e = a.length, g = 0;
            if (typeof b.length === "number") for (var f = b.length; g < f; g++) a[e++] = b[g]; else for (; b[g] !== j;) a[e++] = b[g++];
            a.length = e;
            return a
        }, grep: function (a, b, e) {
    ...
    (function () {
        c.support = {};
        var a = v.documentElement, b = v.createElement("script"), e = v.createElement("div"), g = "script" + z();
        e.style.display = "none";
        e.innerHTML = "   <link/><table></table><a href='/a' style='color:red;float:left;opacity:.55;'>a</a><input type='checkbox'/>";
        var f = e.getElementsByTagName("*"), l = e.getElementsByTagName("a")[0];
        if (!(!f || !f.length || !l)) {
            c.support = {
    ...
    var W = "jQuery" + z(), Za = 0, Ha = {};
    c.extend({
        cache: {}, expando: W, noData: {
    ...
    c.extend({
        queue: function (a, b, e) {
            if (a) {
                ...
                var g = c.data(a, b);
                if (!e) return g || [];
                if (!g || c.isArray(e)) g = c.data(a, b, c.makeArray(e)); else g.push(e);
                return g
            }
        }, dequeue: function (a, b) {
            b = b || "fx";
            var e = c.queue(a, b), g = e.shift();
    ...
    var Ia = /[\n\t]/g, sa = /\s+/, $a = /\r/g, ab = /href|src|style/, bb = /(button|input)/i,
        cb = /(button|input|object|select|textarea)/i,
        db = /^(a|area)$/i, Ja = /radio|checkbox/;
    c.fn.extend({
        attr: function (a, b) {
            ...
            if (a && typeof a === "string") for (var b = (a || "").split(sa), e = 0, g = this.length; e < g; e++) {
                ...
                if (f.nodeType === 1) if (f.className) {
                    for (var l = " " + f.className + " ",
                             k = f.className, s = 0, m = b.length; s < m; s++) if (l.indexOf(" " + b[s] + " ") < 0) k += " " + b[s];
            ...
            var e = typeof a, g = typeof b === "boolean";
            ...
            if (a === j) {
                ...
                if (b) {
                    ...
                    if (c.nodeName(b, "select")) {
                        var e = b.selectedIndex, g = [], f = b.options;
                        b = b.type === "select-one";
                        if (e < 0) return null;
                        var l = b ? e : 0;
            ...
            return this.each(function (m) {
                ...
                if (this.nodeType === 1) {
                    ...
                    if (c.isArray(y) && Ja.test(this.type)) this.checked = c.inArray(r.val(), y) >= 0; else if (c.nodeName(this, "select")) {
                        var B = c.makeArray(y);
    ...
    c.event = {
        add: function (a, b, e, g) {
            if (!(a.nodeType === 3 || a.nodeType === 8)) {
                ...
                if (l = c.data(a)) {
                    var k = l.events = l.events || {}, s = l.handle;
                    ...
                    for (var m, r = 0, y; m = b[r++];) {
                        ...
                        l.type = m;
                        l.guid = e.guid;
                        var B = k[m], F = c.event.special[m] || {};
                        if (!B) {
                            B = k[m] = [];
                            if (!F.setup || F.setup.call(a, g, y, s) === false) if (a.addEventListener) a.addEventListener(m, s, false); else a.attachEvent && a.attachEvent("on" + m, s)
                        }
                        if (F.add) {
                            F.add.call(a, l);
        ...
        remove: function (a, b, e, g) {
            if (!(a.nodeType === 3 || a.nodeType === 8)) {
                var f, l = 0, k, s, m, r, y, B, F = c.data(a),
                    I = F && F.events;
                if (F && I) {
                    if (b && b.type) {
                        e = b.handler;
        ...
        trigger: function (a, b, e, g) {
            ...
            if (!a.isPropagationStopped() &&
                g) c.event.trigger(a, b, g, true); else if (!a.isDefaultPrevented()) {
                g = a.target;
                var k, s = c.nodeName(g, "a") && f === "click", m = c.event.special[f] || {};
        ...
        special: {
            ready: {setup: c.bindReady, teardown: c.noop}, live: {
                add: function (a) {
                    ...
                    var b = true, e = a.origType.replace(da, "");
                    c.each(c.data(this,
    ...
    var Ka = v.removeEventListener ? function (a, b, e) {
    ...
    c.Event.prototype = {
        ...
        }, isDefaultPrevented: G, isPropagationStopped: G,
    ...
    if (!c.support.changeBubbles) {
        var ta =
            /textarea|input|select/i, ua, Na = function (a) {
            var b = a.type, e = a.value;
            if (b === "radio" || b === "checkbox") e = a.checked; else if (b === "select-multiple") e = a.selectedIndex > -1 ? c.map(a.options, function (g) {
                return g.selected
            }).join("-") : ""; else if (a.nodeName.toLowerCase() === "select") e = a.selectedIndex;
            return e
        }, va = function (a, b) {
            var e = a.target, g, f;
    ...
    c.each(["bind", "one"], function (a, b) {
        c.fn[b] = function (e, g, f) {
            ...
            if (e === "unload" && b !== "one") this.one(e, g, f); else {
                l = 0;
    ...
    c.fn.extend({
        unbind: function (a, b) {
            if (typeof a === "object" && !a.preventDefault) for (var e in a) this.unbind(e, a[e]); else {
                e =
                    0;
    ...
    c.each(["live", "die"], function (a, b) {
        c.fn[b] = function (e, g, f, l) {
            var k, s = 0, m, r, y = l || this.selector, B = l ? this : c(this.context);
            if (c.isFunction(g)) {
                f = g;
                g = j
            }
            for (e =
                ...
                if (k === "hover") e.push("mouseenter" + m, "mouseleave" + m); else {
                    r = k;
                    if (k === "focus" || k === "blur") {
                        e.push(Oa[k] + m);
                        k += m
    ...
    (function () {
        function a(h) {
            for (var i = "", n, q = 0; h[q]; q++) {
                n = h[q];
                if (n.nodeType === 3 || n.nodeType === 4) i += n.nodeValue; else if (n.nodeType !== 8) i += a(n.childNodes)
            }
            return i
        }
        ...
        var g = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^[\]]*\]|['"][^'"]*['"]|[^[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,
            f = 0, l = Object.prototype.toString, k = false, s = true;
        [0, 0].sort(function () {
            s = false;
            return 0
        });
        var m = function (h, i, n, q) {
            ...
            if (w.length > 1 && y.exec(h)) if (w.length === 2 && r.relative[w[0]]) A = wa(w[0] + w[1], i); else for (A = r.relative[w[0]] ? [i] : m(w.shift(), i); w.length;) {
                h = w.shift();
                ...
                if (i) {
                    ...
                    if (w.length > 0) E = F(A); else X = false;
                    for (; w.length;) {
                        var O = w.pop();
                        C = O;
                        if (r.relative[O]) C = w.pop(); else O = "";
                        if (C == null) C = i;
                        r.relative[O](E, C, ba)
                    }
                } else E = []
            ...
            } else for (h = 0; E[h] != null; h++) E[h] && E[h].nodeType === 1 && n.push(A[h]); else n.push.apply(n, E); else F(E, n);
            if (ja) {
                m(ja, x, n, q);
                m.uniqueSort(n)
            }
        ...
        m.filter = function (h, i, n, q) {
            for (var x = h, w = [], C = i, A, E, ja = i && i[0] && D(i[0]); h && i.length;) {
                for (var X in r.filter) if ((A = r.leftMatch[X].exec(h)) != null && A[2]) {
                    ...
                    if (O.substr(O.length - 1) !== "\\") {
                        ...
                        if (A) for (var la = 0; (O = C[la]) != null; la++) if (O) {
                            Y = ba(O, A, la, C);
                            var Pa = q ^ !!Y;
                            if (n && Y != null) if (Pa) E = true; else C[la] = false; else if (Pa) {
                                w.push(O);
                                E = true
                            }
                        }
                ...
                if (h === x) if (E == null) m.error(h); else break;
                x = h
            }
            return C
        };
        ...
        var r = m.selectors =
            {
                ...
                relative: {
                    "+": function (h, i) {
                        var n = typeof i === "string", q = n && !/\W/.test(i);
                        n = n && !q;
                ...
                preFilter: {
                    CLASS: function (h, i, n, q, x, w) {
                        ...
                        if (h[1] ===
                            "not") if ((g.exec(h[3]) || "").length > 1 || /^\w/.test(h[3])) h[3] = m(h[3], null, null, i); else {
                ...
                filter: {
                    PSEUDO: function (h, i, n, q) {
                        var x = i[1], w = r.filters[x];
                        if (w) return w(h,
                            n, i, q); else if (x === "contains") return (h.textContent || h.innerText || a([h]) || "").indexOf(i[3]) >= 0; else if (x === "not") {
                            i = i[3];
                            n = 0;
        ...
        try {
            ...
            F = function (h, i) {
                i = i || [];
                if (l.call(h) === "[object Array]") Array.prototype.push.apply(i, h); else if (typeof h.length === "number") for (var n = 0, q = h.length; n < q; n++) i.push(h[n]); else for (n = 0; h[n]; n++) i.push(h[n]);
                return i
            }
        }
        var H;
        if (v.documentElement.compareDocumentPosition) H = function (h, i) {
            ...
            var n = h.ownerDocument.createRange(), q = i.ownerDocument.createRange();
            n.setStart(h, 0);
            n.setEnd(h, 0);
            q.setStart(i, 0);
            q.setEnd(i, 0);
        ...
        (function () {
            var h = v.createElement("div"), i = "script" + (new Date).getTime();
    ...
    var fb = /Until$/, gb = /^(?:parents|prevUntil|prevAll)/, hb = /,/;
    ...
    var Qa = function (a, b, e) {
        if (c.isFunction(b)) return c.grep(a, function (f, l) {
            ...
            if (M.test(b)) return c.filter(b, g, !e); else b = c.filter(b, g)
        }
    ...
    c.fn.extend({
        find: function (a) {
            for (var b =
                this.pushStack("", "find", a), e = 0, g = 0, f = this.length; g < f; g++) {
                e = b.length;
                c.find(a, this[g], b);
    ...
    c.extend({
        filter: function (a, b, e) {
            ...
            var g = [];
            for (a =
                     a[b]; a && a.nodeType !== 9 && (e === j || a.nodeType !== 1 || !c(a).is(e));) {
    ...
    var Ra = / jQuery\d+="(?:\d+|null)"/g, ma = /^\s+/, Sa = /(<([\w:]+)[^>]*?)\/>/g,
        ib = /^(?:area|br|col|embed|hr|img|input|link|meta|param)$/i, Ta = /<([\w:]+)/, jb = /<tbody/i,
        kb = /<|&#?\w+;/, Ca = /<script|<object|<embed|<option|<style/i,
        Da = /checked\s*(?:[^=]|=\s*.checked.)/i, Ua = function (a, b, e) {
    ...
    Q.th = Q.td;
    if (!c.support.htmlSerialize) Q._default =
        [1, "div<div>", "</div>"];
    c.fn.extend({
        text: function (a) {
            ...
            for (var e = 0, g; (g = this[e]) != null; e++) if (!a || c.filter(a, [g]).length) {
                if (!b && g.nodeType === 1) {
            ...
            var b = this.map(function () {
                if (!c.support.noCloneEvent && !c.isXMLDoc(this)) {
                    var e = this.outerHTML, g = this.ownerDocument;
                    if (!e) {
            ...
            if (a === j) return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(Ra,
                "") : null; else if (typeof a === "string" && !Ca.test(a) && (c.support.leadingWhitespace || !ma.test(a)) && !Q[(Ta.exec(a) || ["", ""])[1].toLowerCase()]) {
                a = a.replace(Sa, Ua);
                try {
    ...
    c.extend({
        clean: function (a, b, e, g) {
            ...
            for (var f = [], l = 0, k; (k = a[l]) != null; l++) {
                ...
                if (k) {
                    if (typeof k === "string" && !kb.test(k)) k = b.createTextNode(k); else if (typeof k === "string") {
                        k = k.replace(Sa, Ua);
                        var s = (Ta.exec(k) || ["",
                            ""])[1].toLowerCase(), m = Q[s] || Q._default, r = m[0], y = b.createElement("div");
                    ...
                    if (k.nodeType) f.push(k); else f =
                        c.merge(f, k)
                }
            }
            if (e) for (l = 0; f[l]; l++) if (g && c.nodeName(f[l], "script") && (!f[l].type || f[l].type.toLowerCase() === "text/javascript")) g.push(f[l].parentNode ? f[l].parentNode.removeChild(f[l]) : f[l]); else {
                f[l].nodeType === 1 && f.splice.apply(f, [l + 1, 0].concat(c.makeArray(f[l].getElementsByTagName("script"))));
                e.appendChild(f[l])
            }
            return f
        }, cleanData: function (a) {
            for (var b, e, g = c.cache, f = c.event.special, l = c.support.deleteExpando, k = 0, s; (s = a[k]) != null; k++) if (e = s[c.expando]) {
                b = g[e];
                if (b.events) for (var m in b.events) f[m] ?
                    c.event.remove(s, m) : Ka(s, m, b.handle);
                if (l) delete s[c.expando]; else s.removeAttribute && s.removeAttribute(c.expando);
                delete g[e]
            }
        }
    });
    var lb = /z-?index|font-?weight|opacity|zoom|line-?height/i, Va = /alpha\([^)]*\)/, Wa = /opacity=([^)]*)/,
        xa = /float/i, ya = /-([a-z])/ig, mb = /([A-Z])/g, nb = /^-?\d+(?:px)?$/i, ob = /^-?\d/,
        pb = {position: "absolute", visibility: "hidden", display: "block"}, qb = ["Left", "Right"],
        rb = ["Top", "Bottom"], sb = v.defaultView && v.defaultView.getComputedStyle,
        Xa = c.support.cssFloat ? "cssFloat" : "styleFloat", za =
            function (a, b) {
            ...
            if (b === "width" || b === "height") {
                ...
                function k() {
                    ...
                    g !== "border" && c.each(l, function () {
                        ...
                        if (g === "margin") f += parseFloat(c.curCSS(a, "margin" + this, true)) || 0; else f -= parseFloat(c.curCSS(a,
    ...
    if (c.expr && c.expr.filters) {
        c.expr.filters.hidden = function (a) {
            var b =
                a.offsetWidth, e = a.offsetHeight, g = a.nodeName.toLowerCase() === "tr";
    ...
    var tb = z(), ub = /<script(.|\s)*?\/script>/gi, vb = /select|textarea/i,
        wb = /color|date|datetime|email|hidden|month|number|password|range|search|tel|text|time|url|week/i,
        ca = /=\?(&|$)/, Aa = /\?/, xb = /(\?|&)_=.*?(&|$)/, yb = /^(\w+:)?\/\/([^\/?#]+)/, zb = /%20/g, Ab = c.fn.load;
    c.fn.extend({
        load: function (a, b,
                        e) {
            if (typeof a !== "string") return Ab.call(this, a); else if (!this.length) return this;
            var g = a.indexOf(" ");
            if (g >= 0) {
            ...
            var l = this;
            c.ajax({
                url: a, type: g, dataType: "html", data: b, complete: function (k, s) {
    ...
    c.extend({
        get: function (a, b, e, g) {
            ...
            var f = c.extend(true, {}, c.ajaxSettings, a), l, k, s, m = a && a.context || f, r = f.type.toUpperCase();
            ...
            if (f.dataType === "jsonp") {
                if (r === "GET") ca.test(f.url) || (f.url += (Aa.test(f.url) ?
                    "&" : "?") + (f.jsonp || "callback") + "=?"); else if (!f.data || !ca.test(f.data)) f.data = (f.data ? f.data + "&" : "") + (f.jsonp || "callback") + "=?";
                f.dataType = "json"
            }
            ...
            if (f.cache ===
                false && r === "GET") {
                var y = z(), B = f.url.replace(xb, "$1_=" + y + "$2");
            ...
            if (f.dataType === "script" && r === "GET" && y) {
                var F = v.getElementsByTagName("head")[0] || v.documentElement, I = v.createElement("script");
                I.src = f.url;
            ...
            if (D) {
                ...
                var h = D.onreadystatechange = function (x) {
                    if (!D || D.readyState === 0 || x === "abort") {
                        ...
                        if (k === "success" || k === "notmodified") l || b(); else c.handleError(f, D, k, w);
                        e();
                        x === "timeout" && D.abort();
                        if (f.async) D = null
                    }
            ...
            var e = a.getResponseHeader("Last-Modified"), g = a.getResponseHeader("Etag");
            if (e) c.lastModified[b] = e;
            if (g) c.etag[b] = g;
            return a.status === 304 || a.status === 0
        }, httpData: function (a, b, e) {
            var g = a.getResponseHeader("content-type") || "", f = b === "xml" || !b && g.indexOf("xml") >= 0;
            ...
            if (typeof a === "string") if (b ===
                "json" || !b && g.indexOf("json") >= 0) a = c.parseJSON(a); else if (b === "script" || !b && g.indexOf("javascript") >= 0) c.globalEval(a);
            return a
        }, param: function (a, b) {
            function e(k, s) {
    ...
    var Ba = {}, Bb = /toggle|show|hide/, Cb = /^([+-]=)?([\d+-.]+)(.*)$/, na,
        Ea = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    c.fn.extend({
        show: function (a, b) {
            if (a || a === 0) return this.animate(T("show", 3), a, b); else {
                a = 0;
            ...
            if (a || a === 0) return this.animate(T("hide", 3), a, b); else {
                a = 0;
                for (b = this.length; a < b; a++) {
                    var e = c.data(this[a], "olddisplay");
        ...
        animate: function (a, b, e, g) {
            ...
            return this[f.queue === false ? "each" : "queue"](function () {
                var l = c.extend({}, f), k, s = this.nodeType === 1 && c(this).is(":hidden"), m = this;
                for (k in a) {
                ...
                c.each(a, function (y, B) {
                    ...
                    if (Bb.test(B)) F[B === "toggle" ? s ? "show" : "hide" : B](a); else {
                        var I = Cb.exec(B), H = F.cur(true) || 0;
                        if (I) {
                            B = parseFloat(I[2]);
                            var P = I[3] || "px";
                            if (P !== "px") {
        ...
        update: function () {
            ...
            if (a || b >= this.options.duration + this.startTime) {
                ...
                if (e) {
                    ...
                    if (this.options.hide || this.options.show) for (var f in this.options.curAnim) c.style(this.elem,
    ...
    v.documentElement ? function (a) {
        ...
        var e = b.getBoundingClientRect(), g = b.ownerDocument;
        b = g.body;
        g = g.documentElement;
        return {
        ...
        if (b === b.ownerDocument.body) return c.offset.bodyOffset(b);
        c.offset.initialize();
        var e = b.offsetParent, g = b, f = b.ownerDocument, l, k = f.documentElement, s = f.body;
        g = (f = f.defaultView) ? f.getComputedStyle(b, null) : b.currentStyle;
        for (var m = b.offsetTop, r = b.offsetLeft; (b = b.parentNode) && b !== s && b !== k;) {
    ...
    c.offset = {
        initialize: function () {
            var a = v.body, b = v.createElement("div"), e, g, f, l = parseFloat(c.curCSS(a, "marginTop", true)) || 0;
            c.extend(b.style, {
                position: "absolute",
                top: 0,
                left: 0,
            ...
            var g = c(a), f = g.offset(), l = parseInt(c.curCSS(a, "top", true), 10) || 0,
    ...
    c.fn.extend({
        position: function () {
            ...
            var a = this[0], b = this.offsetParent(), e = this.offset(),
    ...
    c.each(["Left", "Top"], function (a, b) {
        ...
        c.fn[e] = function (g) {
            ...
            if (g !== j) return this.each(function () {
                if (l = V(this)) l.scrollTo(!a ? g : c(l).scrollLeft(), a ? g : c(l).scrollTop()); else this[e] = g
...
jQuery.extend(jQuery.easing, {
    def: "easeOutQuad", swing: function (p, j, u, t, o) {
...
(function (p) {
    ...
    p.fx.prototype.cur = function () {
        if (this.prop == "rotate") return parseFloat(p(this.elem).rotate()); else if (this.prop == "scale") return parseFloat(p(this.elem).scale());
        return u.apply(this, arguments)
    };
...
(function (p) {
    p.fn.quicksand = function (j, u, t) {
        ...
        var z;
        if (typeof u == "function") z = u; else if (typeof (t == "function")) z = t;
        return this.each(function (G) {
            var U, R = [], S = p(j).clone(), L = p(this);
            G = p(this).css("height");
            var Z, ea = false, fa = p(L).offset(), T = [], V = p(this).find(o.selector);
            if (p.browser.msie && p.browser.version.substr(0,
                1) < 7) L.html("").append(S); else {
                var c = 0, oa = function () {
                    if (!c) {
                        L.html(N.html());
                ...
                if (o.adjustHeight === "dynamic") L.animate({height: N.height()}, o.duration, o.easing); else if (o.adjustHeight === "auto") {
                    Z = N.height();
                    if (parseFloat(G) < parseFloat(Z)) L.css("height", Z); else ea = true
                }
                V.each(function () {
                    var K = [];
                    ...
                    if (K.length) o.useScaling ? R.push({
                        ...
                        element: p(this),
                        animation: {top: K.offset().top - v.top, left: K.offset().left - v.left, opacity: 1}
